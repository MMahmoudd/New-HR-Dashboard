...
<script>
  ...
  const Services = ServiceFactory.get('companies')
  export default {
    name: 'Companies',
    data: (vm) => ({
      search: '',
      ...
      headers: [
        {
          text: vm.$t('companies.code'),
          align: 'start',
          sortable: false,
          value: 'code',
        },
        { text: vm.$t('companies.companyName'), sortable: false, value: 'name' },
        { text: vm.$t('companies.companyLogo'), sortable: false, value: 'image' },
    ...
    methods: {
      ...
      async exportExel () {
        ...
        const tHeader = ['Company Name', 'Code']
