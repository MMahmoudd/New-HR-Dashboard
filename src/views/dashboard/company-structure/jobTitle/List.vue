    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:[`item.companies`]="{ item }">
          <span
            v-for="(i, index) in item.companies"
            :key="index"
          >
            "{{ i.name }}"
          </span>
...
<script>
  ...
  export default {
    ...
    data: (vm) => ({
      ...
      headers: [
        { text: vm.$t('departments.Name'), sortable: false, value: 'name' },
        { text: vm.$t('departments.company'), sortable: false, value: 'companies' },
        { text: vm.$t('departments.department'), sortable: false, value: 'department_id' },
    ...
    methods: {
      ...
      async exportExel () {
        ...
        const tHeader = ['Job Name', 'Department Name', 'Company Name']
        const list = List.data.map(item => {
          return { name: item.name, department: item.department_id, companies: item.companies }
        })
