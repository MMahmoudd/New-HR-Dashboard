    ...
    data: (vm) => ({
     ...
     private_mobile:'',
      ...
      headers: [
         ...
         { text: vm.$t('Full Name'), sortable: false, value: 'FullName' },
         { text: vm.$t('FirstName'), sortable: false, value: 'FirstName' },
         { text: vm.$t('LastName'), sortable: false, value: 'LastName' },
        //  { text: vm.$t('email'), sortable: false, value: 'email' },
         { text: vm.$t('BussniessMobile'), sortable: false, value: 'BussniessMobile' },
         { text: vm.$t('PrivateMobile'), sortable: false, value: 'PrivateMobile' },
         ...
         { text: vm.$t('JobTitle'), sortable: false, value: 'JobTitle' },
         { text: vm.$t('Department'), sortable: false, value: 'Department' },

//
        // { text: vm.$t('title'), sortable: false, value: 'title' },
        //   { text: vm.$t('company_id'), sortable: false, value: 'company_categories[0][company_id]' },
        //     { text: vm.$t('categories'), sortable: false, value: 'company_categories[0][categories]' },
        // { text: vm.$t('image.companyLogo'), sortable: false, value: 'image' },
        //  { text: vm.$t('created'), sortable: false, value: 'created_at' },
    ...
    methods: {
      ...
      async exportExel () {
        ...
        const tHeader = ['Code', 'FullName','FirstName','LastName','BussniessMobile','PrivateMobile','NationalId','StartDate'
        ,'Company','Category','JobTitle','Department']
        const list = List.data.map(item => {
          return { Code: item.Code, FullName: item.FullName,
          FirstName: item.FirstName,
          LastName: item.LastName,
          BussniessMobile: item.BussniessMobile,
