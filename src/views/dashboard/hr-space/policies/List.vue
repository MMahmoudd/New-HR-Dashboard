  ...
  <v-container fluid>
    <v-card>
      <v-card-title>
        ...
        <router-link :to="{ path: '/policiesForm' }" color="primary">
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
              <router-link :to="'/policiesForm/' + item.id">
                <v-btn
                  small
                  fab
                  outlined
...
const Services = ServiceFactory.get("policies");
export default {
  name: "policies",
  data: (vm) => ({
    search: "",
    ...
    headers: [
      { text: vm.$t("Policies.id"), sortable: false, value: "id" },
      { text: vm.$t("Policies.Title"), sortable: false, value: "title" },
      { text: vm.$t("Policies.file"), sortable: false, value: "file" },
      {
        text: vm.$t("Policies.company"),
        sortable: false,
        value: "companies",
      },
  ...
  methods: {
    ...
    async exportExel() {
      ...
      import("@/vendor/Export2Excel").then((excel) => {
        const tHeader = ["id", "title", "file", "companies"];
