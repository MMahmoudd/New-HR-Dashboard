  ...
  <v-container fluid>
    <v-card>
      <v-card-title>
        ...
        <router-link :to="{ path: '/newsForm' }" color="primary">
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
              <router-link :to="'/newsForm/' + item.id">
                <v-btn
                  small
                  fab
                  outlined
...
export default {
  ...
  data: (vm) => ({
    ...
    headers: [
      { text: vm.$t("news.id"), sortable: false, value: "id" },
      { text: vm.$t("news.title"), sortable: false, value: "title" },
      {
        text: vm.$t("news.description"),
        sortable: false,
        value: "description",
      },
      {
        text: vm.$t("news.company_id"),
        sortable: false,
        value: "company_categories[0][company_id]",
      },
      {
        text: vm.$t("news.categories"),
        sortable: false,
        value: "company_categories[0][categories]",
      },
      { text: vm.$t("news.companyLogo"), sortable: false, value: "image" },
      { text: vm.$t("news.created"), sortable: false, value: "created_at" },
