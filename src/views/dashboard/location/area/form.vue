<template>
  ...
  >
    <v-card class="py-5">
      <v-card-title>
        {{ this.$route.params.id ? $t('area.edit') : $t('area.add') }}
      </v-card-title>
      <template>
        <v-form
          v-model="valid"
  ...
  export default {
    ...
    methods: {
      ...
      async  submitForm () {
        ...
        this.data.city_id && formData.append('city_id', this.data.city_id)
        this.data.latitude && formData.append('latitude', this.data.latitude)
        this.data.longitude && formData.append('longitude', this.data.longitude)
        this.data.name && formData.append('name', this.data.name)
        this.data.radius && formData.append('radius', this.data.radius)
      ...
      async fetchAllCities () {
        this.dataLoading = true
        const List = await cityServices.getAllItems()
