...
const Services = ServiceFactory.get("missions");
...
export default {
  ...
  data: (vm) => ({
    ...
    headers: [
      {
        text: vm.$t("Mission.MissionStartDate"),
        sortable: false,
        value: "from_day",
      },
      {
        text: vm.$t("Mission.MissionEndDate"),
        sortable: false,
        value: "to_day",
      },
      { text: vm.$t("Mission.sender"), sortable: false, value: "sender" },
      {
        text: vm.$t("Mission.DirectManager"),
        sortable: false,
        value: "dircet_manager",
      },
      { text: vm.$t("Mission.status"), sortable: false, value: "status" },
      { text: vm.$t("Mission.details"), sortable: false, value: "details" },
