...
const Services = ServiceFactory.get("MainReport");
...
export default {
  ...
  data: (vm) => ({
    ...
    headers: [
      { text: vm.$t("Main.Code"), sortable: false, value: "Code" },
      { text: vm.$t("Main.EmployeeName"), sortable: false, value: "FullName" },
      { text: vm.$t("Main.JobTitle"), sortable: false, value: "JobTitle" },
      { text: vm.$t("Main.Category"), sortable: false, value: "Category" },
      { text: vm.$t("Main.Company"), sortable: false, value: "Company" },
      { text: vm.$t("Main.StartDate"), sortable: false, value: "StartDate" },
      {
        text: vm.$t("Main.managers"),
        sortable: false,
        value: "managers",
      },
      { text: vm.$t("Main.Areas"), sortable: false, value: "areas[0][name]" },
      { text: vm.$t("Main.Department"), sortable: false, value: "department" },
    ],
    filename: "Main",
    bookType: "xlsx",
    autoWidth: true,
