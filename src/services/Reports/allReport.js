...
const resource = `${API_URL}/reports/signInOut`
export default {
  getAllItems (itemsPerPage, page, pageNumber,keyword ={},list={}) {
    ...
    const paginate = (itemsPerPage && itemsPerPage !== '') ? '&paginate=' + itemsPerPage : ''
      ...
      const fromDate = (keyword.dateFrom && keyword != '') ? "&from_day=" + keyword.dateFrom : '';
      const toDate = (keyword.dateTo && keyword != '') ? "&to_day=" + keyword.dateTo : '';
