...
const resource = `${API_URL}/reports/execuses`
export default {
  getAllItems (itemsPerPage, page, pageNumber,keyword,list) {
    ...
    const paginate = (itemsPerPage && itemsPerPage !== '') ? '&paginate=' + itemsPerPage : ''
      ...
      const department_id = (list.department_id && list.department_id != '') ? "&department_id=" + list.department_id : '';
      const jobtitle_id = (list.jobtitle_id && list.jobtitle_id != '') ? "&jobtitle_id=" + list.jobtitle_id : '';
